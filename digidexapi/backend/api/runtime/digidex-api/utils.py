...
def paginaton(path, count_levels, page, page_size,
              page_elements, **kwargs):
    next_page = create_page_url_digimon(path, page_size, page + 1,
                                        page_elements, **kwargs)
    previous_page = create_page_url_digimon(path, page_size, page - 1,
                                            page_elements, **kwargs)
